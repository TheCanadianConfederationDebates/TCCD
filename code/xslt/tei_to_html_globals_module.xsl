...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="teiDocs" select="$xmlDocs[TEI[not(@xml:id=('debate', 'debate_day'))][text/descendant::persName[@ref[. != 'UNSPECIFIED']] or @xml:id=('personography', 'bibliography', 'project', 'taxonomies', 'placeography') or contains(@xml:id, 'Morris') or contains(@xml:id, 'Erasmus')]]"/>
