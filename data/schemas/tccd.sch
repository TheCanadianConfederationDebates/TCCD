...
attributes @target and @cRef may be supplied on <name/>.</report>
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron"
      ...
      <sch:rule xmlns:xi="http://www.w3.org/2001/XInclude"
         ...
         <sch:assert test="ancestor::tei:TEI[@xml:id=('personography', 'project', 'placeography', 'taxonomies', 'bibliography')] or (child::tei:name[@ref] and child::tei:date[@when or (@from and @to)])">
...
On <name/>, either the @marks attribute should be used, or a paragraph of description provided</report>
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron"
      ...
      <sch:rule xmlns:xi="http://www.w3.org/2001/XInclude"
                ...
                xmlns:math="http://www.w3.org/1998/Math/MathML"
                xmlns="http://www.tei-c.org/ns/1.0"
                context="tei:div[@type=('document', 'section')][not(ancestor::tei:TEI[@xml:id = ('personography', 'project', 'placeography', 'taxonomies', 'bibliography')])]">
   ...
   <pattern xmlns="http://purl.oclc.org/dsdl/schematron"
      ...
      <sch:rule xmlns:xi="http://www.w3.org/2001/XInclude"
                ...
                xmlns:math="http://www.w3.org/1998/Math/MathML"
                xmlns="http://www.tei-c.org/ns/1.0"
                context="tei:div[parent::tei:body][not(ancestor::tei:TEI[@xml:id = ('personography', 'project', 'placeography', 'taxonomies', 'bibliography')])]">
